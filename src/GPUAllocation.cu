...
{   
    ...
    cudaMemcpyAsync(part_tmp->x+offset, part->x+offset, sizeof(FPpart)*nop, cudaMemcpyHostToDevice, stream);
    cudaMemcpyAsync(part_tmp->y+offset, part->y+offset, sizeof(FPpart)*nop, cudaMemcpyHostToDevice, stream);
    cudaMemcpyAsync(part_tmp->z+offset, part->z+offset, sizeof(FPpart)*nop, cudaMemcpyHostToDevice, stream);
    cudaMemcpyAsync(part_tmp->u+offset, part->u+offset, sizeof(FPpart)*nop, cudaMemcpyHostToDevice, stream);
    cudaMemcpyAsync(part_tmp->v+offset, part->v+offset, sizeof(FPpart)*nop, cudaMemcpyHostToDevice, stream);
    cudaMemcpyAsync(part_tmp->w+offset, part->w+offset, sizeof(FPpart)*nop, cudaMemcpyHostToDevice, stream);
    cudaMemcpyAsync(part_tmp->q+offset, part->q+offset, sizeof(FPinterp)*nop, cudaMemcpyHostToDevice, stream);
}
...
{   
    ...
    cudaMemcpyAsync(part->x+offset, part_tmp->x+offset, sizeof(FPpart)*nop, cudaMemcpyDeviceToHost, stream);
    cudaMemcpyAsync(part->y+offset, part_tmp->y+offset, sizeof(FPpart)*nop, cudaMemcpyDeviceToHost, stream);
    cudaMemcpyAsync(part->z+offset, part_tmp->z+offset, sizeof(FPpart)*nop, cudaMemcpyDeviceToHost, stream);
    cudaMemcpyAsync(part->u+offset, part_tmp->u+offset, sizeof(FPpart)*nop, cudaMemcpyDeviceToHost, stream);
    cudaMemcpyAsync(part->v+offset, part_tmp->v+offset, sizeof(FPpart)*nop, cudaMemcpyDeviceToHost, stream);
    cudaMemcpyAsync(part->w+offset, part_tmp->w+offset, sizeof(FPpart)*nop, cudaMemcpyDeviceToHost, stream);
    cudaMemcpyAsync(part->q+offset, part_tmp->q+offset, sizeof(FPinterp)*nop, cudaMemcpyDeviceToHost, stream);
}
